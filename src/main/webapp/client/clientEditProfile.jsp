        ...
        <div class="client-card">
            ...
            <form action="<%=request.getContextPath() %>/ClientController" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="emergencyContactName" value="<%= c.getEmergencyContactName() != null ? c.getEmergencyContactName() : "" %>" class="form-control">
                </div>
                
                <div class="mb-3">
                    <label class="form-label">Emergency Contact Phone</label>
                    <input type="text" name="emergencyContactPhone" value="<%= c.getEmergencyContactPhone() != null ? c.getEmergencyContactPhone() : "" %>" class="form-control">
                </div>
